let Hotel,Order,fs;_0d4‍.x([["create",()=>create],["hotels",()=>hotels],["image",()=>image],["sellerHotels",()=>sellerHotels],["remove",()=>remove],["read",()=>read],["update",()=>update],["userHotelBookings",()=>userHotelBookings],["isAlreadyBooked",()=>isAlreadyBooked],["searchListings",()=>searchListings]]);_0d4‍.w("../models/hotel",[["default",["Hotel"],function(v){Hotel=v}]]);_0d4‍.w("../models/order",[["default",["Order"],function(v){Order=v}]]);_0d4‍.w("fs",[["default",["fs"],function(v){fs=v}]]);
  ...
  try {
    ...
    hotel.save((err, result) => {
      if (err) {
        _0d4‍.g.console.log('saving hotel err => ', err);
        res.status(400).send('Error saving');
      }
      res.json(result);
    });
  } catch (err) {
    _0d4‍.g.console.log(err);
    res.status(400).json({
      err: err.message
    });
  }
